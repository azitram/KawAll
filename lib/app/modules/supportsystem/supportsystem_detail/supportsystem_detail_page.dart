...
class SupportSystemDetail extends StatelessWidget {
  final CourseList list;

  const SupportSystemDetail({Key? key, required this.list}) : super(key: key);
              ...
              children: [
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xffD37557), //background
